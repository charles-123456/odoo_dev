...
#   Bride  
    ...
    bride_middle_name = fields.Char(string="Middle Name")
...
#   Bridegroom  
    ...
    bridegroom_middle_name = fields.Char(string="Middle Name")
...
class ResAnointingSick(models.Model):
    _name = "res.anointing.sick"
    _description = "Anointing of Sick"
    _order = 'name'
    
    @api.depends('anointing_parish_id')
    def _compute_anointing_diocese(self):
        if self.anointing_parish_id:
            self.anointing_diocese_id = self.anointing_parish_id.diocese_id.id
    
    name = fields.Char(string='First Name', required=True)
    middle_name = fields.Char(string="Middle Name")
    last_name = fields.Char(string='Last Name')
    offline = fields.Char(string="Offline ID")
    ...
    anointing_date = fields.Datetime(string='Date of Anointing')
    anointing_parish_id = fields.Many2one('res.parish', string='Parish of Anointing')
    anointing_diocese_id = fields.Many2one('res.ecclesia.diocese', compute='_compute_anointing_diocese', string='Diocese of Anointing', store=True)
    minister = fields.Char(string='Minister')
    register_reference = fields.Char(string='Register Reference')
    note = fields.Text(string='Note')
...
#   Death Details
    ...
    funeral_directors = fields.Char(string="Funeral Directors")
#   burial Details
